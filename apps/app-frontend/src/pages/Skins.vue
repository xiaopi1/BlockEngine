...
const messages = defineMessages({
	...
	signInDescription: {
		...
		defaultMessage:
			'Please sign into your Minecraft account to use the skin management features of Block Engine.',
	},
	signInButton: {
...
<template>
	...
	>
		...
		>
			<img
				src="@/assets/instance-icons/grass-block.png"
